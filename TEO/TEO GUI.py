#terapija euthyroxom tj TEO skraceno :)
...
def POZOVI_TEA(korisnik):
    ...
    def saznaj_dozu(): #klikom na taj gumb pacijent slusa snimke temeljene na info iz formulara (novi k.) ili baze (stari k)
        ...
        def ProcitajDozuNaTemeljuFormulara():
            ...
            rj_dani={0:"ponedeljak.wav",1:"utorak.wav",2:"srijeda.wav",3:"cetvrtak.wav",4:"petak.wav",5:"subota.wav",6:"nedelja.wav"}
            
            #-----------------POTREBNI UVJETI ZA CITANJE PODATAKA na temelju formulara:-----------------
            if brojac_tableta<=0:
                poredane_snimke=[rj_dani[danasnji_dan],"nemateViseTableta.wav"]
                ...
                if rok_trajanja==True and nisam_danas_pio==True:
                    ...
                    RJ_DOZE_1={'25mg':"uzmite25.wav",'50mg':"uzmite50.wav",'100mg':"uzmite100.wav",'200mg':"uzmite200.wav"}
                    RJ_DOZE_2={'25mg':"iiJednu25.wav",'50mg':"iiJednu50.wav",'100mg':"iiJednu100.wav",'200mg':"iiJednu200.wav",'2.tableta?':'tisina.wav',"ne uzimam drugu":'tisina.wav'}#ZA 2. TABLETU


                    DOZA1=RJ_DOZE_1[doze_tuple_1[danasnji_dan]] 
                    DOZA2=RJ_DOZE_2[doze_tuple_2[danasnji_dan]]
                    
                    poredane_snimke=[rj_dani[danasnji_dan],DOZA] #DOZU ZA ODREDENI DAN MORAMO DOHVTIT IZ BAZE

                    conn.commit()
                    
                elif rok_trajanja==False and nisam_danas_pio==True:
                    poredane_snimke=[rj_dani[danasnji_dan],"RokTrajanjaIstekao.wav"]

                elif nisam_danas_pio==False:
                    poredane_snimke=[rj_dani[danasnji_dan],"pripazite!.wav"]
                    
                
            def ProcitajTerapiju():
                #-----------citanje snimki umetnutih u listu: ---------
                for snimka in poredane_snimke:
                    winsound.PlaySound(snimka,winsound.SND_ALIAS)
                return
            ProcitajTerapiju()
                ...
                if RokTrajanjaTableta_TEO()==True:
                    for PravoKoristenja in c.execute("SELECT PravoKoristenja FROM Pacijent"):
                        if PravoKoristenja[0]=='True':
                            poredane_snimke=[rj_dani[danasnji_dan],DOZA1,DOZA2] #DOZA1 i DOZA2 se citaju iz baze...
                            conn.commit()
